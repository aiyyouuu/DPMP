...
<body>
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
          ...
          <a class="navbar-brand" href="<?= base_url('index.php/kepala/home') ?>"><span>Dinas Penanaman Modal</span> Dan Perizinan Yogyakarta</a>
      </div>
    </div>
  </nav>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <div class="divider"></div>
      <ul class="nav menu">
        <li <?= $this->uri->segment(4) == 'laporan' ? 'class="active"' : null ?>><a href="<?= base_url('kepala/keptransaksi/laporan') ?>"><em class="fa fa-money">&nbsp;</em> Permohonan ACC</a></li>
