<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <ol class="breadcrumb">
      <li><a href="<?= base_url('index.php/admin/home') ?>">
            ...
            <tbody>
              <?php $no=1; foreach ($transaksi as $value): ?>
                <tr>
                  ...
                  <td align="center">
                    <a href="<?= base_url('index.php/admin/admtransaksi/laporan/' . $value['id_barang']) ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i><?= $value['Keterangan']?></a></td>
                </tr>
              <?php endforeach ?>
            </tbody>
          </table>
