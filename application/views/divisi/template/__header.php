...
<body>
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
          ...
          <a class="navbar-brand" href="<?= base_url('index.php/divisi/home') ?>"><span>Dinas Penanaman Modal</span> Dan Perizinan Yogyakarta</a>
      </div>
    </div>
  </nav>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <div class="divider"></div>
      <ul class="nav menu">
        <li <?= $this->uri->segment(3) == 'barang' ? 'class="active"' : null ?>><a href="<?= base_url('index.php/divisi/barang') ?>"><em class="fa fa-database">&nbsp;</em> Pengajuan Sistem</a></li>
        <li <?= $this->uri->segment(3) == 'transaksi' ? 'class="active"' : null ?>><a href="<?= base_url('index.php/divisi/transaksi') ?>"><em class="fa fa-money">&nbsp;</em> Upgrade Sistem</a></li>
        <li <?= $this->uri->segment(4) == 'laporan' ? 'class="active"' : null ?>><a href="<?= base_url('index.php/divisi/transaksi/laporan') ?>"><em class="fa fa-money">&nbsp;</em> History Upgrade</a></li>
