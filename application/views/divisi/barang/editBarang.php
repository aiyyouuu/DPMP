<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Data Pengajuan Sistem</li>
    </ol>
  </div><!--/.row-->

  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Ubah Data Pengajuan Sistem</h1>
    </div>
  </div><!--/.row-->
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('index.php/divisi/barang/ubah') ?>" method="POST">
