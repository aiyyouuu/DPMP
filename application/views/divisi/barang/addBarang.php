<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Data Pengajuan Sistem</li>
    </ol>
  </div><!--/.row-->

  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Tambah Data Pengajuan Sistem</h1>
    </div>
  </div><!--/.row-->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <a href="<?= base_url('index.php/divisi/barang') ?>" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>

        <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('index.php/divisi/barang/tambah') ?>" method="POST">
              <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>">
              <div class="form-group <?= form_error('nama_barang') ? 'has-error' : null ?>">
                <label for="nama_barang">Nama Pengajuan Sistem<span class="text-danger">*</span></label>
              ...
              <div class="form-group <?= form_error('stock_barang') ? 'has-error' : null ?>">
                <label for="stock_barang">Stock  <span class="text-danger">*</span></label>
