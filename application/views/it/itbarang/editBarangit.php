    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <a href="<?= base_url('index.php/it/itbarang') ?>" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>

        <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('index.php/it/itbarang/ubah') ?>" method="POST">
