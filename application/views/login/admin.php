      ...
      <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        ...
        <div class="login-panel panel panel-default" >
          ...
          <div class="panel-body">
            <form action="<?php echo base_url('index.php/Auth/prosesLogin') ?>" method="POST" role="form">
              ...
              <fieldset>
                ...
                <div class="checkbox">
                  <label>
                    <input onclick="lihatPassword()" type="checkbox">Lihat Password</label>
                </div>
