...
class itbarang extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('it/itbarang/indexit', $data);
	...
	public function tambah() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('it/ittemplate/__header', $data);
			$this->load->view('it/itbarang/addBarangit', $data);
			$this->load->view('it/ittemplate/__footer');
	...
	public function ubah() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('it/ittemplate/__header', $data);
			$this->load->view('it/itbarang/editBarangit', $data);
			$this->load->view('it/ittemplate/__footer');
