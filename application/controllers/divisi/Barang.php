...
class Barang extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('divisi/template/__header', $data);
		$this->load->view('divisi/barang/index', $data);
		$this->load->view('divisi/template/__footer');
	}
	...
	public function tambah() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('divisi/template/__header', $data);
			$this->load->view('divisi/barang/addBarang', $data);
			$this->load->view('divisi/template/__footer');
	...
	public function ubah() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('divisi/template/__header', $data);
			$this->load->view('divisi/barang/editBarang', $data);
			$this->load->view('divisi/template/__footer');
